...
'''
PART 3: SUPPORT VECTOR MACHINE MODELING - GRID SEARCH
...
param_grid = {'C': [0.5, 1.0, 1.5, 2, 2.5, 3],
...
results_df, results_detailed = iterate_grid_search(SVC(random_state=42, probability=True), param_grid, labels, X_data, y_data, return_detail=True)
...
'''
PART 4: SVM CLASSIFICATION MODELING
'''

# svm - five labels
model_five = SVC(kernel='rbf', C=3, random_state=42, probability=True)
...
# svm - three labels
model_three = SVC(kernel='rbf', C=3, random_state=42, probability=True)
...
# svm - strict three labels
model_strict_three = SVC(kernel='rbf', C=3, random_state=42, probability=True)
...
# svm - two labels
model_two = SVC(kernel='linear', C=0.5, random_state=42, probability=True)
...
model_strict_two = SVC(kernel='rbf', C=2.5, random_state=42, probability=True)
...
Models:
    - Strict Three Labels: 73.61% Accuracy
    - Strict Two Labels: 96.30% Accuracy
'''
...
# svm - important three classes
model_important_three = SVC(kernel='rbf', C=3, random_state=42, probability=True)
...
# svm - important two classes
model_important_two = SVC(kernel='rbf', C=2.5, random_state=42, probability=True)
...
# save results
reddit_results.to_csv('svm_reddit_results.csv', index=False)
